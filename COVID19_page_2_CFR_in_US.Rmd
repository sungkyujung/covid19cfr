...
## Latest State-wise Case Fatality Rates(TOP 10 states in No. confirmed patients) as of 3/31/2020
...
barplot(-unlist(N[nrow(N),TOP10.index][rev(CFR.order)]),horiz = T,
        axes=F,yaxt="n",space=0.5,col="white",xlim=c(-max_x_lim-10000,-0+5000))
options("scipen" = 100)
axis(side = 1, at = -seq(0, max_x_lim, by = 25000),
     labels = seq(0, max_x_lim, by = 25000),
