...
C <- read.csv("China/China_Cured.csv", header = TRUE, row.names = 1)
D <- read.csv("China/China_Dead.csv", header = TRUE, row.names = 1)
U <- read.csv("China/China_Unknown.csv", header = TRUE, row.names = 1)
N <- read.csv("China/China_Confirmed.csv", header = TRUE, row.names = 1)
