...
## Latest Country-wise Case Fatality Rates (TOP 10 countries in No. confirmed patients) as of 4/1/2020
...
barplot(-unlist(N[nrow(N),TOP10.index][rev(CFR.order)]),horiz = T,
        axes=F,yaxt="n",space=0.5,col="white",xlim=c(-max_x_lim-10000,-0+10000))
options("scipen" = 100)
axis(side = 1, at = -seq(0, max_x_lim, by = 100000),
     labels = seq(0, max_x_lim, by = 100000),
...
legend(x= 0.35, y = 11.9, legend = c("Our model", "WHO 1st"),
