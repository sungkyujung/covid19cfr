...
## Latest Age Group-wise Case Fatality Rates as of 4/20/2020
```{r figure_2_agegroup_ci, echo = FALSE, fig.height = 7, fig.width = 12}
par(mar = c(6, 8, 8, 3))

max_x_lim = 5000
barplot(-unlist(N[nrow(N),]),horiz = T,axes=F,yaxt="n",space=0,
        col = "gray",xlim=c(-max_x_lim-500,-0+200))
...
legend(x= 0.29, y = 10.8, legend = c("Our model", "Naive CFR"),
