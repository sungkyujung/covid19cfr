---
title: "COVID-19 Case Fatality Rate: China"
#author: "Byungwon Kim"
date: "6/29/2020"
---
...
C <- read.csv("China_Cured.csv", header = TRUE, row.names = 1)
D <- read.csv("China_Dead.csv", header = TRUE, row.names = 1)
U <- read.csv("China_Unknown.csv", header = TRUE, row.names = 1)
N <- read.csv("China_Confirmed.csv", header = TRUE, row.names = 1)
...
## Latest Province-wise Case Fatality Rates(TOP 10 provinces in No. confirmed patients) as of 6/29/2020
...
options("scipen" = 100)
axis(side = 1, at = -seq(0, max_x_lim, by = 50000),
     labels = seq(0, max_x_lim, by = 50000),
...
title(ylab = "Province",line = 11,cex.lab = 1.3)
title(xlab="# of confirmed cases", line = 2.5,cex.lab = 1.7)
title(main="CFR", line = 3,cex.main=1.7)
legend(x= 0.175, y = 11.9, legend = c("Our model", "Naive CFR"),
