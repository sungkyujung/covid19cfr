...
C <- read.csv("Global/Global_Cured.csv", header = TRUE, row.names = 1)
D <- read.csv("Global/Global_Dead.csv", header = TRUE, row.names = 1)
U <- read.csv("Global/Global_Unknown.csv", header = TRUE, row.names = 1)
N <- read.csv("Global/Global_Confirmed.csv", header = TRUE, row.names = 1)
